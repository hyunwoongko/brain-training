...
// is located at.
const serviceAccount = require('./braintraining-fb978-firebase-adminsdk-ivdqe-d5d39db6d2');
...
function updateOrCreateUser(userId, email, displayName, photoURL) {
  ...
  if (photoURL) {
    updateParams['photoURL'] = photoURL;
      ...
      updateParams['photoURL'] = "http://placehold.it/100?text=No+Image"
  }
...
// Start the server
const server = app.listen(process.env.PORT || '9890', () => {
